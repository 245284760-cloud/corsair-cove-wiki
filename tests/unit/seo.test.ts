...
import { metadata as shipsMetadata } from '@/app/ships/page'
import { metadata as explorationMetadata } from '@/app/exploration/page'
...
describe('production SEO routes', () => {
  ...
  it('publishes canonical article metadata for each new core information route', () => {
    ...
    expect(canonicals).toEqual([
      ...
      'https://corsaircovewiki.com/ships/',
      'https://corsaircovewiki.com/exploration/',
      'https://corsaircovewiki.com/updates/',
    ])
